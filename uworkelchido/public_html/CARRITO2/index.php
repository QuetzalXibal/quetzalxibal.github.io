    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Fansite shop</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php } ?>
                         <a href="./salir.php" class="nav-link text-info" category="all">Iniciar Sesion</a>
                         <a href="../SESION/Registro.php" class="nav-link text-info" category="all">Crear Cuenta</a>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Fansite</h1>
                <p class="lead fw-normal text-white-50 mb-0">Shop.</p>
            </div>
        </div>
    </header>
    <section class="py-5">
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                            <div class="card h-100">
                                ...
                                <!-- Product image-->
                                <img class="card-img-top" src="../CARRITO/assets/img/<?php echo $data['imagen']; ?>" alt="..." />
                                <!-- Product details-->
