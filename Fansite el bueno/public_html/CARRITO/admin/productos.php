            ...
            $('.editarProducto').on('click', function(){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        $('#p_normal').val(product.precio_normal);
                        $('#p_rebajado').val(product.precio_rebajado);
                        $('#categoria').val(product.id_categoria);
                        $('#id').val(product.id); // Aquí se añade el id al campo de formulario oculto

                        // luego abre la ventana modal
...
<body>
    <!-- La parte restante del HTML va aquí -->
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="get" action="editar.php" class="d-inline">
                                    <button class="btn btn-primary editarProducto" type="button" data-id="<?php echo $data['id']; ?>">Editar</button>
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
